...
train_inputs_resampled, train_labels_resampled = overSampler.fit_resample(train_inputs, train_labels)
train_masks_resampled, _ = overSampler.fit_resample(train_masks, train_labels)
