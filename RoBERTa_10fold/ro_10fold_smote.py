...
def tokenize_texts(texts):
    return tokenizer(texts, padding=True, truncation=True, return_tensors='pt', max_length=150)
...
train_inputs_resampled, train_labels_resampled = smote.fit_resample(train_inputs, train_labels)
train_masks_resampled, _ = smote.fit_resample(train_masks, train_labels)
...
store_fine_tuned = "roberta-smote-10fold-chinese"
