...
- **Class Distribution**: 
  ...
  - Class 1 (Positive): 1755 samples (74.8%)
- **Imbalance Ratio**: 2.96:1
...
|-------|----------|-----------|--------|----------|---------|-------------------|
| SVM | 0.920 | 0.957 | 0.936 | 0.946 | 0.951 | 0.0266 |
| Naive_Bayes | 0.892 | 0.963 | 0.889 | 0.924 | 0.929 | 0.0005 |
| Random_Forest | 0.900 | 0.964 | 0.900 | 0.930 | 0.964 | 0.0721 |
...
- **Fastest Model**: Naive_Bayes (0.0005s per batch)
- **Highest Throughput**: Naive_Bayes (505709 samples/second)
